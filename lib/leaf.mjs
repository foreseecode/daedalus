...
// Avoid to re subscribe to DOM events after several calls to init()
let _isWatchingClicks = false;
let _isWatchingScrolls = false;
...
function watchClicks() {
  if (_isWatchingClicks) return;
  _isWatchingClicks = true;
...
function watchScrolls() {
  if (_isWatchingScrolls) return;
  _isWatchingScrolls = true;
